...
public class NearbyOperatorAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.tvActive = (TextView) convertView.findViewById(R.id.tvNearbyActive);
		...
		holder.tvActive.setText(operator.getActiveNo());
	...
	static class ViewHolder{
		private TextView tvCallsign,tvHandle,tvLastSeen,tvActive;
